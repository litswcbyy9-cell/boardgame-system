...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[scale=1.2]
    ...
    \node[draw, rectangle, thick, fill=blue!20, minimum width=2cm, minimum height=1cm] (table) at (7,0) {桌位};

    % 联系
    \node[draw, diamond, thick, fill=orange!20, minimum width=1.5cm, minimum height=1cm] (rel) at (3.5,0) {包含};

    % 属性
    \node[draw, ellipse, fill=purple!20] (v_id) at (0,2.5) {id};
    \node[draw, ellipse, fill=purple!20] (v_name) at (-2,1.2) {name};
    \node[draw, ellipse, fill=purple!20] (v_addr) at (2,1.2) {address};
    \node[draw, ellipse, fill=purple!20] (t_id) at (7,2.5) {id};
    \node[draw, ellipse, fill=purple!20] (t_code) at (5,1.2) {code};
    \node[draw, ellipse, fill=purple!20] (t_pos) at (9,1.2) {pos\_x, pos\_y};
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[scale=1.1]
    ...
    \node[draw, rectangle, thick, fill=blue!20] (res) at (5,0) {预约};
    \node[draw, rectangle, thick, fill=blue!20] (player) at (10,0) {会员};

    % 联系
    \node[draw, diamond, thick, fill=orange!20] (rel1) at (2.5,0) {预订};
    \node[draw, diamond, thick, fill=orange!20] (rel2) at (7.5,0) {参与};
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[scale=1.1]
    % 实体
    \node[draw, rectangle, thick, fill=blue!20] (table) at (0,0) {桌位};
    \node[draw, rectangle, thick, fill=blue!20] (session) at (5,0) {对局会话};
    \node[draw, rectangle, thick, fill=blue!20] (res) at (10,0) {预约};

    % 联系
    \node[draw, diamond, thick, fill=orange!20] (rel1) at (2.5,0) {占用};
    \node[draw, diamond, thick, fill=orange!20] (rel2) at (7.5,0) {来源};
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[scale=1.0]
    ...
    \node[draw, rectangle, thick, fill=blue!20] (record) at (5,0) {战绩};
    \node[draw, rectangle, thick, fill=blue!20] (game) at (10,1.5) {游戏目录};
    \node[draw, rectangle, thick, fill=blue!20] (player) at (10,-1.5) {会员};

    % 联系
    \node[draw, diamond, thick, fill=orange!20] (rel1) at (2.5,0) {产生};
    \node[draw, diamond, thick, fill=orange!20] (rel2) at (7.5,1.5) {对应};
    \node[draw, diamond, thick, fill=orange!20] (rel3) at (7.5,-1.5) {获胜};
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[scale=1.0]
    % 实体 - 拉开间距
    \node[draw, rectangle, thick, fill=blue!20] (table) at (0,0) {桌位};
    \node[draw, double, rectangle, thick, fill=cyan!20] (state) at (5.5,0) {桌位状态};

    % 联系
    \node[draw, diamond, thick, fill=orange!20] (rel) at (2.75,0) {当前状态};
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[scale=0.9]
    ...
    \node[draw, rectangle, thick, fill=blue!20] (game) at (7,4) {游戏目录};
    \node[draw, rectangle, thick, fill=blue!20] (table) at (0,2) {桌位};
    \node[draw, double, rectangle, thick, fill=cyan!20] (state) at (0,0) {桌位状态};
    \node[draw, rectangle, thick, fill=blue!20] (player) at (7,2) {会员};
    \node[draw, rectangle, thick, fill=blue!20] (stats) at (9.5,2) {会员统计};
    \node[draw, rectangle, thick, fill=blue!20] (res) at (2.5,1) {预约};
    \node[draw, rectangle, thick, fill=blue!20] (session) at (2.5,-1) {对局会话};
    \node[draw, rectangle, thick, fill=blue!20] (record) at (5,-1) {战绩};
